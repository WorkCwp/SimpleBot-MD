...
import { makeWASocket, protoType, serialize } from './src/lb/simple.js';
import { initializeSubBots } from './src/lib/subBotManager.js';
...
const connectionOptions = {
  ...
  mobile: MethodMobile,
  browser: opcion === '1' ? ['By:WorkCwp', 'Safari', '2.0.0'] : methodCodeQR ? ['Criwilop-MD', 'Safari', '2.0.0'] : ['Ubuntu', 'Chrome', '20.0.04'],
  auth: {
    creds: state.creds,
...
setInterval(async () => {
  ...
  const bio = `• Activo: ${uptime} | Criwilop-MD`;
